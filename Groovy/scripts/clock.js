...
function data() {
    ...
    document.getElementById("info").innerHTML = open ? "<div><a href = 'javascript:clickedClose()' style = '-webkit-tap-highlight-color: rgba(0, 0, 0, 0);'><img align = 'left' src = 'x.png' height = '15' width = '15' style = '-webkit-tap-highlight-color: rgba(0, 0, 0, 0);'></a><div align = 'right' style = 'margin-right:5%;font-size:19px;font-family:RR'>" + hm + ampm + "</div><table style = 'color:" + textColorInfo + ";border-top: 1px solid " + textColorInfo + ";'><tr><td colspan = '3' style = 'text-align: center'>" + weekDayAbbrev + ". " + monthAbbrev + " " + date + ", " + year + "</td></tr>" + html + "</div>": "";
}
