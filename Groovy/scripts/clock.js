...
function data() {
    ...
    document.getElementById("above").innerHTML = weekDayFull + ", " + monthAbbrev + " " + d.getDate();
    document.getElementById("time").innerHTML = h + ":" + m + ampm;
}
setInterval(data, 1000);
data();

function clicked(focused) {
    document.getElementById("above").style.opacity = focused ? 1.0 : 0.0;
    document.getElementById("below").style.opacity = focused ? 1.0 : 0.0;
    if (focused){
